...
export const layout = {
  ...
  _spaceMainAxis: _spaceMainAxis.spaceAround,
  //   _spaceCrossAxis,
}
...
export const getDim = d => Math.round(dimWidth * (d / _width))
export const viewWidth = procent =>
  Dimensions.get('window').width * procent * 0.01
